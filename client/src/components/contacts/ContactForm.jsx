      ...
      <div className="relative z-10 py-20">
        ...
        <div className="px-8 flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2">
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8 lg:p-12 animate-fade-in-up h-full">
              <form onSubmit={handleFormSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Phone Number */}
                  <div>
